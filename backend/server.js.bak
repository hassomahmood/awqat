...
// ── Hijri date adjustment per country ─────────────────────────────────────────
// AlAdhan's default Hijri date follows the Saudi/Ummul Qura calendar.
// Different countries follow local moon sighting which can differ by ±1 day.
// adjustment: -1 means the country is typically 1 day BEHIND Saudi Arabia.
//
// Sources: official moon sighting authorities of each country.
const HIJRI_ADJUSTMENT = {
  // -1 day from Saudi (local sighting, typically one day later)
  PK: -1,  // Pakistan  — Ruet-e-Hilal Committee
  IN: -1,  // India     — Hilal Committee
  BD: -1,  // Bangladesh
  MY: -1,  // Malaysia  — Jabatan Kemajuan Islam Malaysia (JAKIM)
  ID: -1,  // Indonesia — Nahdlatul Ulama / Muhammadiyah
  SG: -1,  // Singapore — MUIS
  LK: -1,  // Sri Lanka
  NG: -1,  // Nigeria
  KE: -1,  // Kenya
  ZA: -1,  // South Africa
  GB: -1,  // UK        — Hilal Sighting (ICOUK)
  US: -1,  // USA       — ISNA / local sighting
  CA: -1,  // Canada
  FR: -1,  // France
  DE: -1,  // Germany
  NL: -1,  // Netherlands
  // 0 = same as Saudi (Gulf states follow Saudi declaration)
  SA:  0,  // Saudi Arabia
  AE:  0,  // UAE
  KW:  0,  // Kuwait
  QA:  0,  // Qatar
  BH:  0,  // Bahrain
  OM:  0,  // Oman
  EG:  0,  // Egypt      — follows Saudi
  JO:  0,  // Jordan
  TR:  0,  // Turkey
  // Iran follows its own astronomical calculation (usually same or -1)
  IR: -1,  // Iran
  IQ: -1,  // Iraq
};

function getHijriAdjustment(country) {
